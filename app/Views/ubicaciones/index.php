...
<div class="card-header">
    <div class="d-flex justify-content-between mb-3">
        <h2>Ubicaciones</h2>
        <a href="<?= site_url('ubicaciones/create') ?>" class="btn btn-success"><i class="bi bi-plus-circle me-1"></i>
            Registrar Ubicaciones</a>
    </div>
</div>
<div class="card-body">
                ...
                <?php foreach ($ubicaciones as $item): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= site_url('ubicaciones/delete/' . $item['id_ubicacion']) ?>" class="btn btn-danger "
